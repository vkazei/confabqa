...
Judge spot-check: see `triviaqa_judge_spotcheck.md`. **Caveat:** the
...
|---|--:|--:|--:|--:|--:|
| full | 800 | 76.63% (L21) | 71.62% (`text_only`) | +5.00 | NO |
| short_answer | 649 | 75.35% (L17) | 67.80% (`text_only`) | +7.55 | NO |
...
| **hidden-state probe peak** | **76.63%** (L21, $\pm$ 2.64 pp) |
| h adds vs strongest | **+5.00 pp** |
...
- short-answer half (word-length $\le$ 2): h adds = +7.55 pp
- long-answer half (word-length $>$ 2): h adds = +0.00 pp
- short minus long: +7.55 pp
