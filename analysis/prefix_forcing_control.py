...
def main():
    ...
    parser.add_argument("--prefix", default=FORCED_PREFIX,
                        help="literal first token(s) to force")
    ...
    slug = "" if prefix == "As" else "_" + "".join(c for c in prefix if c.isalnum()).lower()
    out_path = FIGURES_DIR / f"prefix_forcing_control{slug}.json"
