...
% ----- 6.1 Probe-direction atlas: the refusal signal in token space -----
\subsection{6.1 Probe-direction atlas: the refusal signal in token space}\label{probe-direction-atlas-what-the-refusal-signal-points-at-in-token-space}
